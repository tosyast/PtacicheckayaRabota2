...
namespace PracticWork2
{
    internal class Program
    {
        static void Main()
        {
            ...
            {
                Console.WriteLine("Игра - угадай число. Попробуй угадать :)");
                ...
                do
                {
                    ...
                    {
                        Console.WriteLine("Слишком много, надо меньше, котя");
                    }
                    if (int.Parse(ygadivayou) < chislooo)
                    {
                        Console.WriteLine("Слишком мало, надо больше, котя");
                    }
                } while (chislooo != int.Parse(ygadivayou));
                Console.WriteLine("Поиграли и хватит. Ты выиграл!!!");
